...
import com.ianm1647.expandeddelight.screen.slot.LockedSlot;
import com.ianm1647.expandeddelight.screen.slot.ResultSlot;
...
public class JuicerScreenHandler extends ScreenHandler {
    ...
    public JuicerScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
    ...
    public JuicerScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.blockEntity = ((JuicerBlockEntity) blockEntity);
        this.propertyDelegate = arrayPropertyDelegate;

        this.addSlot(new Slot(inventory, 0, 48, 25));
        this.addSlot(new Slot(inventory, 1, 48, 43));
        this.addSlot(new Slot(inventory, 2, 80, 60));
        this.addSlot(new LockedSlot(inventory, 3, 116, 35));
        this.addSlot(new ResultSlot(inventory, 4, 116, 60));
